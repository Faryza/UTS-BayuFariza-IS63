...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Catat Pembayaran Baru</h1>
    ...
    <div class="col-lg-8 col-md-10">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-warning text-dark">
                <h6 class="m-0 font-weight-bold">Formulir Catat Pembayaran</h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('pembayaran.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('penyewa_id') is-invalid @enderror" id="penyewa_id" name="penyewa_id" required>
                            ...
                            @empty
                                <option value="" disabled>Belum ada penyewa terdaftar!</option>
                            @endforelse
                        </select>
                        @error('penyewa_id')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="3" placeholder="Contoh: Pembayaran sewa Kamar 101 untuk bulan Mei 2026.">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <button type="submit" class="btn btn-warning shadow-sm mr-2 text-dark font-weight-bold">
                        <i class="fas fa-save mr-1"></i> Catat Pembayaran
                    </button>
