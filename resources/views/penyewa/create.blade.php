...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Registrasi Penyewa Baru</h1>
    ...
    <div class="col-lg-8 col-md-10">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-success text-white">
                <h6 class="m-0 font-weight-bold">Formulir Penyewa Baru</h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('penyewa.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control @error('kamar_id') is-invalid @enderror" id="kamar_id" name="kamar_id" required>
                            ...
                            @empty
                                <option value="" disabled>Tidak ada kamar kosong yang tersedia!</option>
                            @endforelse
                        </select>
                        @error('kamar_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <button type="submit" class="btn btn-success shadow-sm mr-2">
                        <i class="fas fa-save mr-1"></i> Daftarkan Penyewa
                    </button>
