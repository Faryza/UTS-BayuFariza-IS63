    ...
    <div class="col-lg-8 col-md-10">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Formulir Kamar Baru</h6>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('kamar.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nomor_kamar') is-invalid @enderror" 
                               ...
                               placeholder="Contoh: Room 101, A2, B05" required>
                        @error('nomor_kamar')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('harga_bulanan') is-invalid @enderror" 
                               id="harga_bulanan" name="harga_bulanan" value="{{ old('harga_bulanan') }}" 
                    ...
                    <div class="form-group mb-4">
                        <label for="status" class="font-weight-bold">Status Awal <span class="text-danger">*</span></label>
                        <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                            <option value="Tersedia" {{ old('status') == 'Tersedia' ? 'selected' : '' }}>Tersedia (Vacant)</option>
                    ...
                    <button type="submit" class="btn btn-primary shadow-sm mr-2">
                        <i class="fas fa-save mr-1"></i> Simpan Kamar
                    </button>
